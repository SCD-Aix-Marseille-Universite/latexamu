...
\section{Deuxième section de la première partie}
	...
	l'utilisation des formules dans un environnement autorise les références croisée. Par exemple, nous pouvons faire appel à la formule de la fusion deutérium-tritium \ref{equ:fusion}.