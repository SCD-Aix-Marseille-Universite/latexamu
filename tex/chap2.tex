...
Ajout d'une nouvelle entrée d'index de la centrifugeuse\index{centrifugeuse}. Les entrées $+a$ $2a$ $:a$ $Aa$ $aa$ $\alpha$ {\NoAutoSpaceBeforeFDP "?"}sont dans la nomenclature.
