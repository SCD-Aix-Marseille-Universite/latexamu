...
\section{Deuxième section de la deuxième partie}
	...
	\subsection[Sous-sous section 2]{Deuxième sous-section de la deuxième section} % entre [] pour le texte dans la TOC
		...
		\subsubsection{Ce titre de section ne s'affiche pas dans la TOC (tocdepth=2) mais dans la TOC locale (etocsettocdepth=3)}
			...
			\paragraph{Le choix des centrifugeuses}~~\\
				...
				\begin{figure}
					\centering
					\subfloat[Pour les souris]{\includegraphics[width=.5\textwidth, max height=2in]{photo_centrifugeuse.png}}
					\subfloat[Pour les fruits]{\includegraphics[width=.5\textwidth, max height=2in]{photo_centrifugeuse2.jpg}}
					\caption{Deux centrifugeuses}
					\label{fig:deux_centrifugeuses}
				\end{figure}
