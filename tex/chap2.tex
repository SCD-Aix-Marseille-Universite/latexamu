...
Une première note de fin de document\endnote{Première note de fin de document.}, une deuxième\endnote{Deuxième note de fin de document.} et \ldots \endnote{\ldots note de fin de document.} \endnote{\ldots note de fin de document.} \endnote{\ldots note de fin de document.} \endnote{\ldots note de fin de document.} \endnote{\ldots note de fin de document.} \endnote{\ldots note de fin de document.} \endnote{\ldots note de fin de document.}: le package hyperendnotes.sty permet l'appel et le retour de note\endnote{\lipsum[1]\index{Lorem ipsum}}.
...
Ajout d'une nouvelle entrée d'index de la centrifugeuse\index{centrifugeuse}. Ajout pour le glossaire de \nomenclature{$RGCC$}{Révision Générale du Contenu des Concours} et de \nomenclature{$RIFSEEP$}{Régime indemnitaire tenant compte des fonctions, des sujétions, de l'expertise et de l'engagement professionnel}.
